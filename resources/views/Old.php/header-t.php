...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/preloader.css" />
        <!-- favicon links -->
        <link rel="shortcut icon" type="image/png" href="images/header/animated-logo-dark.png" />
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-xs hidden-sm full_width">
                            <div class="gc_header_wrapper">
                                <div class="gc_logo">
                                    <a href="index.php "><img src="images/header/animated-logo-wd.gif" alt="Logo" title="Workers Direct" class="img-responsive"></a>
                                </div>
                            </div>
                        </div>
