    ...
    <div id="preloader">
            ...
            <div class="wrap">
                <div class="loading">
                  ...
                  <div class="text">  Workers Direct</div>
                </div>
              </div>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-xs hidden-sm full_width">
                        <div class="gc_header_wrapper">
                            <div class="gc_logo">
                                <a href="index.php "><img src="images/header/workers-direct-logo-dark.png" alt="Logo" title="Workers Direct" class="img-responsive"></a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="gc_logo">
                                                <a href="index.php "><img src="images/header/workers-direct-logo-dark.png" alt="Logo" title="Grace Church"></a>
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                        <div class="jp_navi_right_btn_wrapper">
                            <ul>
                                <li><a href="submit-a-job.php "><i class="fa fa-plus-circle"></i>&nbsp; SUBMIT A JOB</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                <div class="cc_slider_cont1_wrapper">
                                    <div class="cc_slider_cont1">
                                        <h2 data-animation-in="fadeInDown" data-animation-out="animate-out fadeOutDown">We Offer <span>30,000+</span><br> Job Vacancies Right Now!</h2>
                                        <h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOutDown">Find Jobs, Employment & Career Opportunities</h1>
                                        <p data-animation-in="zoomIn" data-animation-out="animate-out zoomIn">Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum<br> auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet<br> nibh vulputate cursus a sit
                                            amet mauris. Morbi accumsan</p>
                                        <ul>
                                            <li data-animation-in="bounceInLeft" data-animation-out="animate-out bounceOutLeft"><a href="#"><i class="fa fa-plus-circle"></i> GET STARTED</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="jp_recent_resume_box_wrapper">
                        <div class="jp_recent_resume_img_wrapper">
                            <img src="images/content/resume_img6.jpg" alt="resume_img" />
                        </div>
                        <div class="jp_recent_resume_cont_wrapper">
                            <h3>Meera Thomas</h3>
                            <p><i class="fa fa-folder-open-o"></i> <a href="#">UI Designer</a></p>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="jp_recent_resume_view_btn_wrapper">
                        <div class="jp_recent_resume_view_btn">
                            <ul>
                                <li><a href="#"><i class="fa fa-plus-circle"></i> &nbsp;VIEW ALL</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="jp_client_second_slider_wrapper">
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <img src="images/content/p1.jpg" alt="client_img">
                            </div>
                            <div class="item">
                                <img src="images/content/p2.jpg" alt="client_img">
                            </div>
                            <div class="item">
                                <img src="images/content/p3.jpg" alt="client_img">
                            </div>
                            <div class="item">
                                <img src="images/content/p4.jpg" alt="client_img">
                            </div>
                            <div class="item">
                                <img src="images/content/p5.jpg" alt="client_img">
                            </div>
                            <div class="item">
                                <img src="images/content/p6.jpg" alt="client_img">
                            </div>
                        </div>
                    </div>
                </div>
