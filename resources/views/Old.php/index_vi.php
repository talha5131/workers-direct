...
<body>
				...
				<div class="row">
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-xs hidden-sm full_width">
						<div class="gc_header_wrapper">
							<div class="gc_logo">
								<a href="index.php ">
									<img src="images/index_vi/logo.png" alt="Logo" title="Workers Direct" class="img-responsive">
								</a>
							</div>
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 hidden-sm hidden-xs">
					<div class="jp_banner_right_img">
						<img src="images/index_vi/banner_image.png" alt="img">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="jp_counter_main_wrapper">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="jp_counter_heading">
						<h4>Counter Section</h4>
						<p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non enim.</p>
						<ul>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="jp_counter_main_section_wrapper">
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="gc_counter_cont_wrapper">
									<div class="count-description">
										<div class="jp_count_icon_wrapper">	<i class="fa fa-star"></i> 
										</div>
										<div class="jp_count_icon_cont_wrapper">	<span class="timer">2540</span>
							...
							<div class="col-md-6 col-sm-6">
								<div class="gc_counter_cont_wrapper gc_counter_cont_wrapper3">
									<div class="count-description">
										<div class="jp_count_icon_wrapper">	<i class="fa fa-user-o"></i>
										</div>
										<div class="jp_count_icon_cont_wrapper">	<span class="timer">7325</span>
											<h5 class="con1">Members</h5>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="gc_counter_cont_wrapper gc_counter_cont_wrapper2">
									<div class="count-description">
										<div class="jp_count_icon_wrapper">	<i class="fa fa-trophy"></i>
										</div>
										<div class="jp_count_icon_cont_wrapper">	<span class="timer">1924</span>
											<h5 class="con1">Resumes</h5>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="gc_counter_cont_wrapper gc_counter_cont_wrapper2">
									<div class="count-description">
										<div class="jp_count_icon_wrapper">	<i class="fa fa-location-arrow"></i>
										</div>
										<div class="jp_count_icon_cont_wrapper">	<span class="timer">4275</span>
											<h5 class="con1">Company</h5>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 hidden-sm hidden-xs">
					<div class="jp_down_mob_img_wrapper">
						<img src="images/index_vi/down_img.png" alt="mobail_img" />
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 visible-sm visible-xs">
					<div class="jp_down_mob_img_wrapper">
						<img src="images/index_vi/down_img.png" class="img-responsive" alt="mobail_img" />
					</div>
				</div>
			</div>
		</div>
