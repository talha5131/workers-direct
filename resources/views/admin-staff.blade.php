                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-20">
                        ...
                        <div class="section_heading section_2_heading">
                            ...
                            <h2>Office Support <span> Staff</span></h2>

                        </div>

                        <p>We put all administrative staff that we work with through strict applicant testing and screening, to ensure a successful and rewarding recruitment experience for the employer – and employee! Workers Direct can provide support staff including Administrative and HR assistants with skills ranging from data entry, database management, filing and inputting of orders, and word processing.</p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-20">
                        ...
                        <div class="section_heading section_2_heading">
                            ...
                            <h2>Office <span> Assistant</span></h2>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                        <div class="margin-top-20">
                            <ul>
                                ...
                                <li><i class="fa fa-caret-right"></i> Executive Assistants</li>
                                <li><i class="fa fa-caret-right"></i> Administrative Assistants</li>
                                <li><i class="fa fa-caret-right"></i> Production Assistants</li>
