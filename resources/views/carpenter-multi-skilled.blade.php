            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="about_text_wrapper row">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        ...
                        <div>
                            <ul>
                                <li><i class="fa fa-caret-right"></i> A valid CSCS card appropriate to their work.</li>
                                <li><i class="fa fa-caret-right"></i> Be competent and experienced in the use of construction hand & power tools.</li>
                                <li><i class="fa fa-caret-right"></i> Must be able to drive (If require).</li>
                                <li><i class="fa fa-caret-right"></i> Conduct themselves in a professional manner.</li>
                                <li><i class="fa fa-caret-right"></i> Arrive for work with appropriate PPE which complies with current standards for the work (As a minimum: Safety Footwear, Gloves, Eye protection, Hearing protection, Hard hat, Respiratory Protection).</li>
                                <li><i class="fa fa-caret-right"></i> Be able and willing to accept written and verbal instruction from our site team to undertake a variety of tasks in order to complete the work.</li>
                                <li><i class="fa fa-caret-right"></i> Comply with all Health and Safety legislation and requirements which exist or may be introduced from time to time.</li>
                            </ul>
                        </div>
