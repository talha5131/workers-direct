            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for role of experienced Chef de Partie in the area of Reading.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Prepare menus in collaboration with colleagues</li>
                            <li><i class="fa fa-caret-right"></i> Ensure adequacy of supplies at the cooking stations</li>
                            <li><i class="fa fa-caret-right"></i> Prepare ingredients that should be frequently available (vegetables, spices etc.)</li>
                            <li><i class="fa fa-caret-right"></i> Follow the guidance of the executive or sous chef and have input in new ways of presentation or dishes</li>
                            <li><i class="fa fa-caret-right"></i> Put effort in optimizing the cooking process with attention to speed and quality</li>
                            <li><i class="fa fa-caret-right"></i> Enforce strict health and hygiene standards</li>
                            <li><i class="fa fa-caret-right"></i> Help to maintain a climate of smooth and friendly cooperation</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Proven experience in a Chef de Partie role</li>
                            <li><i class="fa fa-caret-right"></i> Excellent use of various cooking methods, ingredients, equipment and processes</li>
                            <li><i class="fa fa-caret-right"></i> Ability to multitask and work efficiently under pressure</li>
                            <li><i class="fa fa-caret-right"></i> Knowledge of best cooking practices</li>
                            <li><i class="fa fa-caret-right"></i> Culinary school diploma</li>
