        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="jp_contact_heading_wrapper">
                    ...
                    <p>Call us at <span> 0 203 086 90 80</span> or Email us at <a href="mailto:info@workers-direct.com">info@workers-direct.com</a></p>


                </div>

            </div>
            <div class="margin-top-60 text-center col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <form id="contactForm">
                    <div class="jp_contact_form_box">
                        ...
                        <div class="row jp_contact_inputs_wrapper">
                        ...
                        <div class="row jp_contact_inputs_wrapper">
                            ...
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-10 col-xs-10" style="padding-left: 0px;">
                        ...
                        <div class="row jp_contact_inputs_wrapper">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="jp_contact_inputs_wrapper jp_contact_inputs3_wrapper" style="margin-top: 0px;">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="jp_contact_inputs_wrapper jp_contact_inputs4_wrapper" style="margin-top: 17px;">
                                    <label class="formsLabel" for="message">Enter Your Message</label>
                                    <textarea rows="6" placeholder="Type Your Message" id="message" name="message" style="margin-top: 0px;"></textarea>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="jp_contact_form_btn_wrapper">
                                ...
                                <ul>
                                    ...
                                    <li><button type="submit"><i class="fa fa-plus-circle"></i> Send Message</button></li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="jp_contact_right_box_wrapper" style="height: 693px;">

                    <div class="jp_contact_form_add_heading_wrapper">

                        <h2 style="font-size: 25px;">Contact Info</h2>
                    ...
                    <div class="jp_form_add_wrapper gc_map_add_wrapper1">
                        ...
                        <div class="gc_map_location_icon_cont_wrapper">
                            ...
                            <h3 style="font-size: 20px;">344-48 High Road, Ilford, IG1 1QP</h3>
                    ...
                    <div class="jp_form_add_wrapper gc_map_add_wrapper2">
                        ...
                        <div class="gc_map_location_icon_cont_wrapper gc_map_location_icon_cont_wrapper2">
                            ...
                            <h3 style="font-size: 20px;"> 0 203 086 90 80</h3>
                    ...
                    <div class="jp_form_add_wrapper gc_map_add_wrapper2">
                        ...
                        <div class="gc_map_location_icon_cont_wrapper gc_map_location_icon_cont_wrapper3">
                            ...
                            <h3 style="font-size: 20px;"> 02071128033</h3>
                    ...
                    <div class="jp_form_add_wrapper gc_map_add_wrapper3">
                        ...
                        <div class="gc_map_location_icon_cont_wrapper gc_map_location_icon_cont_wrapper4">
                            ...
                            <h3 style="font-size: 20px;"> <a href="mailto:info@workers-direct.com">info@workers-direct.com</a></h3>
