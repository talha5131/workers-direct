...
@section('title','CPCS - 360 Excavator Driver')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="jp_tittle_heading_wrapper">
                    ...
                    <div class="jp_tittle_heading">
                        ...
                        <h1>CPCS - 360 Excavator Driver Jobs</h1>
                    ...
                    <div class="jp_tittle_breadcrumb_main_wrapper">
                        ...
                        <div class="jp_tittle_breadcrumb_wrapper">
                            ...
                            <ul>
                                ...
                                <li>CPCS - 360 Excavator Driver Jobs</li>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12  margin-bottom-20 pl-0">
                ...
                <div class="about_text_wrapper">
                    ...
                    <div class="section_heading section_2_heading">
                        ...
                        <h2>CPCS - 360 Excavator Driver </h2>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-30 pl-0">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>CPCS - 360 Excavator Driver </td>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for a 360 Excavator Driver for one of our clients in Leatherhead Area.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Remove dirt from the building area</li>
                            <li><i class="fa fa-caret-right"></i>Unload excavator in the appropriate area</li>
                            <li><i class="fa fa-caret-right"></i>Coordinate with other workers to determine dig sites</li>
                            <li><i class="fa fa-caret-right"></i>Conduct routine maintenance on your equipment</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>High school diploma or GED certificate</li>
                            <li><i class="fa fa-caret-right"></i>Completed apprenticeship preferred</li>
                            <li><i class="fa fa-caret-right"></i>Vehicle and heavy equipment maintenance experience</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        <p>If you are qualified, interested and have your CPCS tickets valid, Please contact ASAP.</p>
                    </div>
