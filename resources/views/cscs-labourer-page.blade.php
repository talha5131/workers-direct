            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for CSCS Labourers on permanent basis for general labouring work in London.
                            The candidate must have previous experience and full PPE.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>	Clean up worksites from hazardous or obsolete material</li>
                            <li><i class="fa fa-caret-right"></i>	Assist welders, carpenters, painters or other tradespeople on-site</li>
                            <li><i class="fa fa-caret-right"></i>	Handle and transport materials (e.g. cement) and equipment (e.g. drills and grinders)</li>
                            <li><i class="fa fa-caret-right"></i>	Use power tools and machinery (e.g. forklifts) when needed</li>
                            <li><i class="fa fa-caret-right"></i>	Follow instructions from supervisors to perform manual labor tasks (e.g. digging, stacking up goods)</li>
                            <li><i class="fa fa-caret-right"></i>	Put up warning signs (e.g. signposts, cones) for vehicles and passersby</li>
                            <li><i class="fa fa-caret-right"></i>	Help with setting up and transferring temporary structures (e.g. scaffolding)</li>
                            <li><i class="fa fa-caret-right"></i>	Report issues with equipment or unsafe conditions</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Ability to meet the physical demands of the job (standing for long periods of time, lifting heavy loads of up to 40 pounds etc.)</li>
                            <li><i class="fa fa-caret-right"></i>Good hand-eye coordination</li>
                            <li><i class="fa fa-caret-right"></i>Familiarity with power tools and machinery is a plus</li>
                            <li><i class="fa fa-caret-right"></i>Communication and teamwork skills</li>
                            <li><i class="fa fa-caret-right"></i>Commitment to safety rules</li>
                            <li><i class="fa fa-caret-right"></i>Apprenticeship or specialization is an asset, but not necessary</li>
