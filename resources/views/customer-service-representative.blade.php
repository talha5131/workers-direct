...
@section('title','Customer Service Representatives ')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for a role of experienced Customer Service Representatives in the area of Maidenhead.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Manage large amounts of incoming calls</li>
                            <li><i class="fa fa-caret-right"></i> Generate sales leads</li>
                            <li><i class="fa fa-caret-right"></i> Identify and assess customers’ needs to achieve satisfaction</li>
                            <li><i class="fa fa-caret-right"></i> Build sustainable relationships and trust with customer accounts through open and interactive communication</li>
                            <li><i class="fa fa-caret-right"></i> Provide accurate, valid and complete information by using the right methods/tools</li>
                            <li><i class="fa fa-caret-right"></i> Meet personal/customer service team sales targets and call handling quotas</li>
                            <li><i class="fa fa-caret-right"></i> Handle customer complaints, provide appropriate solutions and alternatives within the time limits; follow up to ensure resolution</li>
                            <li><i class="fa fa-caret-right"></i> Keep records of customer interactions, process customer accounts and file documents</li>
                            <li><i class="fa fa-caret-right"></i> Follow communication procedures, guidelines and policies.</li>
                            <li><i class="fa fa-caret-right"></i> Take the extra mile to engage customers</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Proven customer support experience or experience as a Client Service Representative</li>
                            <li><i class="fa fa-caret-right"></i> Track record of over-achieving quota</li>
                            <li><i class="fa fa-caret-right"></i> Strong phone contact handling skills and active listening</li>
                            <li><i class="fa fa-caret-right"></i> Familiarity with CRM systems and practices</li>
                            <li><i class="fa fa-caret-right"></i> Customer orientation and ability to adapt/respond to different types of characters</li>
                            <li><i class="fa fa-caret-right"></i> Excellent communication and presentation skills</li>
                            <li><i class="fa fa-caret-right"></i> Ability to multi-task, prioritize, and manage time effectively</li>
