                ...
                <div class="row about_text_wrapper">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 margin-top-60">
                        ...
                        <div class="margin-top-60">
                            <ul>
                                <li><i class="fa fa-caret-right"></i>Data Entry – collect the relevant industry information online and enter the data on an excel sheet.</li>
                                <li><i class="fa fa-caret-right"></i>Other day to day administrative / online research tasks assigned by management.</li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 margin-top-60">
                        ...
                        <div class="margin-top-60">
                            <ul>
                                <li><i class="fa fa-caret-right"></i>An ideal candidate must have a good typing skill.</li>
                                <li><i class="fa fa-caret-right"></i>Excellent communication ability.</li>
                                <li><i class="fa fa-caret-right"></i>Organizational and time-management skills.</li>
                            </ul>
                        </div>
