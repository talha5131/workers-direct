            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for a role of an experienced Delivery Driver in London.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Deliver a wide variety of items to different addresses and through different routes</li>
                            <li><i class="fa fa-caret-right"></i> Follow routes and time schedule</li>
                            <li><i class="fa fa-caret-right"></i> Load, unload, prepare, inspect and operate a delivery vehicle</li>
                            <li><i class="fa fa-caret-right"></i> Ask for feedback on provided services and resolve clients’ complaints</li>
                            <li><i class="fa fa-caret-right"></i> Collect payments</li>
                            <li><i class="fa fa-caret-right"></i> Inform customers about new products and services</li>
                            <li><i class="fa fa-caret-right"></i> Complete logs and reports</li>
                            <li><i class="fa fa-caret-right"></i> Follow DOT regulations and safety standards</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Proven working experience as a Delivery Driver</li>
                            <li><i class="fa fa-caret-right"></i>Valid professional driver’s license</li>
                            <li><i class="fa fa-caret-right"></i>Ability to operate forklifts and tractors in a variety of weather and traffic conditions</li>
                            <li><i class="fa fa-caret-right"></i>Excellent organizational and time management skills</li>
                            <li><i class="fa fa-caret-right"></i>Good driving record with no traffic violations</li>
