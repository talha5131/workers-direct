...
@section('title','Electricians Mate')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for role of experienced Electricians Mate in the City of London.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>You will be carrying out task such as;</p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 ">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Cable management systems Installation (Tray, ladder, conduit)</li>
                            <li><i class="fa fa-caret-right"></i> Cable Installation</li>
                            <li><i class="fa fa-caret-right"></i> Control panels / PLC & MCC Installations</li>
                            <li><i class="fa fa-caret-right"></i> Lighting installations</li>
                            <li><i class="fa fa-caret-right"></i> Glanding and termination of a variety of power and control cabling</li>
                            <li><i class="fa fa-caret-right"></i> Control system interface wiring</li>
                            <li><i class="fa fa-caret-right"></i> Carrying out basic testing as per BS7671</li>
                            <li><i class="fa fa-caret-right"></i> Understanding and Interpretation of electrical drawings</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Must hold an in date CCSNG safety passport card</li>
                            <li><i class="fa fa-caret-right"></i> Power station or heavy industry experience essential</li>
                            <li><i class="fa fa-caret-right"></i> CCSNG / EMSS requirement</li>
                            <li><i class="fa fa-caret-right"></i> All personnel whom attend site must be clean shaven policy</li>
