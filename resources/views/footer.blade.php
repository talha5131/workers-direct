                    ...
                    <div class="jp_contact_form_box">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="jp_contact_inputs_wrapper jp_contact_inputs3_wrapper">
                                ...
                                <i class="fa fa-phone"></i><input type="text" placeholder="Phone">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="jp_contact_inputs_wrapper jp_contact_inputs3_wrapper">
                                ...
                                <i class="fa fa-map-marker"></i><input type="text" placeholder="Employer/Job Seeker">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="jp_contact_inputs_wrapper jp_contact_inputs3_wrapper">
                                ...
                                <i class="fa fa-pencil-square-o"></i><input type="text" placeholder="Detail">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="jp_contact_form_btn_wrapper">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#"><i class="white fa fa-plus-circle"></i>&nbsp; Get a Quote</a></li>
