            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for a role of an experienced Forklift Driver in the area of West Bourne.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Unload materials and merchandise from incoming vehicles and stack them to assigned places</li>
                            <li><i class="fa fa-caret-right"></i> Locate and move stock of products to pallets or crates for storage or shipment</li>
                            <li><i class="fa fa-caret-right"></i> Identify damages and report shortages or quality deficiencies</li>
                            <li><i class="fa fa-caret-right"></i> Transport raw materials to production workstations</li>
                            <li><i class="fa fa-caret-right"></i> Inspect machinery to determine the need for repairs and guarantee safety by performing regular maintenance</li>
                            <li><i class="fa fa-caret-right"></i> Keep updated records of inventory and activity logs</li>
                            <li><i class="fa fa-caret-right"></i> Comply with company policies and legal guidelines</li>
                            <li><i class="fa fa-caret-right"></i> Help maintain a safe and orderly environment of the facilities</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Proven experience as forklift operator</li>
                            <li><i class="fa fa-caret-right"></i> Attention to detail and familiarity with industrial equipment</li>
                            <li><i class="fa fa-caret-right"></i> Excellent physical condition and coordination</li>
                            <li><i class="fa fa-caret-right"></i> Valid certification to operate forklifts</li>
                            <li><i class="fa fa-caret-right"></i> High school diploma</li>
