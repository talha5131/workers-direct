                    ...
                    <div class="jp_tittle_breadcrumb_main_wrapper">
                        ...
                        <div class="jp_tittle_breadcrumb_wrapper">
                            ...
                            <ul>
                                ...
                                <li>Forklift Driver / Warehouse Assistant</li>
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-30">
                        <table class="table table-bordered " style="width:100%">
                            <tr>
                                <th>Job Title</th>
                                <td>Packer and General Warehouse Assistant (Forklift Driver)</td>
                            </tr>
                            <tr>
                                <th>DEPARTMENT & LOCATION</th>
                                <td>Operational Support – reporting to the Production and Asset Manager</td>
                            </tr>
                            <tr>
                                <th>ROLE OVERVIEW</th>
                                <td>To clean, pack and label repaired goods for shipment to sites. Also to assist the warehouse operative with the preparation of equipment for installations as required.</td>
                            </tr>
                    ...
                    <div class="margin-top-30 col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <ul>
                            ...
                            <li><i class="fa fa-caret-right"></i> Ability to take a flexible and disciplined approach to workload.</li>
                            <li><i class="fa fa-caret-right"></i> Good planning and organisational skills, with the ability to prioritise tasks effectively.</li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="margin-top-60">
                    <p>Any other duties required or directed to deliver the business objectives of the company. This job profile is intended as a guide to inform of the likely type of work for this position and should not be seen as restrictive and as such will be subject to regular review.</p><br>
                    <p><strong>Note:</strong> This Warehouse Assistant job is intended as a guide to inform of the likely type of work for this position and should not be seen as restrictive and as such will be subject to regular review.</p><br>
                    <p>Please contact Bill for more details on <strong>02036171518</strong>.</p>
                </div>
