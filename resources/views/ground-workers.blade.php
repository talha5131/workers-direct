            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for a role of experienced ground workers in the city of London.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Fabricate and tie in steel cages</li>
                            <li><i class="fa fa-caret-right"></i> Set up site and deal with any logistical issues</li>
                            <li><i class="fa fa-caret-right"></i> Mark out the area for the site using string lines strung between stakes</li>
                            <li><i class="fa fa-caret-right"></i> Put up huts, ladders, barriers and safety signs</li>
                            <li><i class="fa fa-caret-right"></i> Lay drainage pipes, pavements and manhole covers</li>
                            <li><i class="fa fa-caret-right"></i> Liaise with clients and or principal contractors for each project and report back to project managers on a daily basis</li>
                            <li><i class="fa fa-caret-right"></i> Redirect waterways</li>
                            <li><i class="fa fa-caret-right"></i> Remove sewage </li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Be able to read bar bending schedules</li>
                            <li><i class="fa fa-caret-right"></i>Reliable</li>
                            <li><i class="fa fa-caret-right"></i>Adaptable</li>
                            <li><i class="fa fa-caret-right"></i>Enthusiastic with good work ethics.</li>
                            <li><i class="fa fa-caret-right"></i>Good communication skills are required and a can do attitude.</li>
                            <li><i class="fa fa-caret-right"></i>Be able to interpret construction drawings and designs</li>
                            <li><i class="fa fa-caret-right"></i>Good general problem solving skills</li>
                            <li><i class="fa fa-caret-right"></i>Basic numeracy skills</li>
                            <li><i class="fa fa-caret-right"></i>High level of physical fitness</li>

                        </ul>
                    </div>

                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        <h4>Qualifications And Education Needed:</h4>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        <p>Groundworkers can either enter the profession following relevant experience, gaining the correct qualifications, or through an apprenticeship.</p>
                    </div>
