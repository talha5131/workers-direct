...
@section('title','HR Assistant Jobs & Administrative Jobs in London')
@section('keywords','hr,assistant')
@section('description','The primary responsibility of the resource would be proper HR administration and co-ordination for recruitment activities. This will include end to end employee HR life cycle including smooth onboarding, handbook maintenance, policy compliances, exit process etc.')
@section('content')
                ...
                <div class="about_text_wrapper abt_2_para">
                    ...
                    <div class="section_heading section_2_heading row">
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            <table class="table table-bordered " style="width:100%">
                                <tr>
                                    <th>Job Title</th>
                                    <td>Virtual HR Assistant (Part Time)</td>
                                </tr>
                                <tr>
                                    <th>Job Category</th>
                                    <td>Admin</td>
                    ...
                    <div class="section_heading section_2_heading margin-top-60">
                        ...
                        <div class="section_heading section_2_heading">
                            ...
                            <h4>Desired Skills and <span> Experience (Must Have)</span></h4>
                    ...
                    <div class="section_heading section_2_heading margin-top-60">
                        <div>
                            <ul>
                                <li><i class="fa fa-caret-right"></i> Graduate degree in English</li>
                                <li><i class="fa fa-caret-right"></i> Excellent communication and interpersonal skills</li>
                                <li><i class="fa fa-caret-right"></i> Highly motivated and energetic</li>
                                <li><i class="fa fa-caret-right"></i> Absolute discretion at all times as you will have access to confidential information</li>
                                <li><i class="fa fa-caret-right"></i> Ability to understand a broad range of business activities from HR to Marketing to Technology to Finance</li>
                                <li><i class="fa fa-caret-right"></i> IT literate; experience of word, Excel, PowerPoint, CRM or database management and other major software applications</li>
                                <li><i class="fa fa-caret-right"></i> Excellent administration and good secretarial skills</li>
                            </ul>
                        </div>
