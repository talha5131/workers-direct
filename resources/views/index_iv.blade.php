...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/animate\.css" /><link rel="stylesheet" type="text/css" href="css/preloader.css" />
	...
	<link rel="stylesheet" type="text/css" href="css/style_iv.css" />

	<link rel="stylesheet" type="text/css" href="css/responsive_iv.css" />
...
<body>
		...
		<div class="gc_main_menu_wrapper">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 hidden-xs hidden-sm full_width">
						...
						<div class="gc_header_wrapper">
							...
							<div class="gc_logo">
								...
								<a href="index.php ">
									...
									<img src="images/index_iv/logo.png" alt="Logo" title="Workers Direct" class="img-responsive">
								...
								<ul class="float_left">
									...
									<li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">  Pages&nbsp;<i class="fa fa-angle-down"></i></a>
                                        ...
                                        <ul>
                                            ...
                                            <li class="parent"><a href="submit-a-job.php ">SUBMIT A JOB</a></li>
											...
											<li class="parent"><a href="message.php ">message</a></li>

											<li class="parent"><a href="client_reivew.php ">client reivew</a></li>
										...
										<div class="col-xs-6 col-sm-6">
											...
											<div class="gc_logo">
												...
												<a href="index.php ">
													...
													<img src="images/index_iv/logo.png" alt="Logo" title="Grace Church">
	...
	<div class="cc_slider_main_wrapper">
		...
		<div class="jp_slider_shape_img">

			<img src="images/index_iv/header_shape.png" alt="shape">
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
								...
								<div class="cc_slider_cont1_wrapper">
									...
									<div class="cc_slider_cont1">
										...
										<h2 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOutDown">We Offer <span>30,000+</span><br> Job Vacancies Right Now!</h2>

										<h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOutDown">Find Jobs, Employment & Career Opportunities</h1>

										<p data-animation-in="fadeInUp" data-animation-out="animate-out fadeOutDown">Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum

											<br>auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet

											<br>nibh vulputate cursus a sit amet mauris. Morbi accumsan</p>

										<ul>

											<li data-animation-in="fadeInUp" data-animation-out="animate-out fadeOutDown"><a href="#"><i class="fa fa-plus-circle"></i> GET STARTED</a>
							...
							<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
								...
								<div class="jp_slider_img">

									<img src="images/index_iv/slider_img.png" alt="img">
	...
	<!-- jp slider form Wrapper Start -->

	<div class="jp_slider_form_wrapper">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="jp_slider_form_main_wrapper">
						...
						<div class="jp_slider_form_input width_50">

							<input type="text" placeholder="Keyword e.g. (Job Title, Description, Tags)">

						</div>

						<div class="jp_slider_form_location_wrapper width_50 width_50_second"> <i class="fa fa-dot-circle-o first_icon"></i>
						...
						<div class="jp_slider_form_location_wrapper width_25"> <i class="fa fa-th-large first_icon"></i>
						...
						<div class="jp_slider_form_location_wrapper width_25 width_25_second"> <i class="fa fa-money first_icon"></i>
						...
						<div class="jp_slider_form_location_wrapper width_35 width_25_second"> <i class="fa fa-line-chart first_icon"></i>
					...
					<div class="jp_slider_form_search">

						<a href="#">

							<img src="images/index_iv/search.png" alt="search">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="cc_featured_product_main_wrapper">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a href="#trand" aria-controls="trand" role="tab" data-toggle="tab">Part Time</a>

							</li>

							<li role="presentation"><a href="#best" aria-controls="best" role="tab" data-toggle="tab">Full Time </a>
							...
							<div class="video_nav_img_wrapper">
								...
								<div class="video_nav_img">
									...
									<ul>
										...
										<li><a class="button secondary url owl_nav" href="#zero">1</a>

										</li>

										<li><a class="button secondary url owl_nav" href="#one">2</a>
	...
	<div class="jp_best_deal_main_wrapper">
		...
		<div class="jp_best_deal_overlay"></div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					...
					<div class="jp_best_deal_main_cont_wrapper">
						...
						<div class="jp_best_deal_icon_sec"> <i class="flaticon-magnifying-glass"></i>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					...
					<div class="jp_best_deal_main_cont_wrapper">
						...
						<div class="jp_best_deal_icon_sec"> <i class="flaticon-users"></i>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					...
					<div class="jp_best_deal_main_cont_wrapper jp_best_deal_main_cont_wrapper2">
						...
						<div class="jp_best_deal_icon_sec"> <i class="flaticon-shield"></i>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					...
					<div class="jp_best_deal_main_cont_wrapper jp_best_deal_main_cont_wrapper2">
						...
						<div class="jp_best_deal_icon_sec"> <i class="flaticon-notification"></i>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					...
					<div class="jp_best_deal_main_cont_wrapper jp_best_deal_main_cont_wrapper2">
						...
						<div class="jp_best_deal_icon_sec"> <i class="flaticon-wallet"></i>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					...
					<div class="jp_best_deal_main_cont_wrapper jp_best_deal_main_cont_wrapper2">
						...
						<div class="jp_best_deal_icon_sec"> <i class="flaticon-people"></i>
								...
								<div class="item">
									...
									<div class="row">
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											...
											<div class="jp_hiring_content_main_wrapper jp_hiring_content_main_wrapper2">

												<div class="jp_hiring_content_wrapper">

													<img src="images/content/hiring_img5.png" alt="hiring_img" />
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-xs">
											...
											<div class="jp_hiring_content_main_wrapper jp_hiring_content_main_wrapper2">
												...
												<div class="jp_hiring_content_wrapper">
													...
													<img src="images/content/hiring_img6.png" alt="hiring_img" />
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
											...
											<div class="jp_hiring_content_main_wrapper jp_hiring_content_main_wrapper2">
												...
												<div class="jp_hiring_content_wrapper">
													...
													<img src="images/content/hiring_img7.png" alt="hiring_img" />
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
											...
											<div class="jp_hiring_content_main_wrapper jp_hiring_content_main_wrapper2">
												...
												<div class="jp_hiring_content_wrapper">
													...
													<img src="images/content/hiring_img8.png" alt="hiring_img" />
	...
	<div class="jp_counter_main_wrapper">
		...
		<div class="jp_counter_img_overlay"></div>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					...
					<div class="jp_popu_cate_box_main_wrapper jp_popu_cate_box_main_wrapper2">
						...
						<div class="jp_top_jobs_category_wrapper">
							...
							<div class="jp_top_jobs_category"> <i class="fa fa-newspaper-o"></i>

								<h3><a href="#">Media & News</a></h3>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					...
					<div class="jp_popu_cate_box_main_wrapper jp_popu_cate_box_main_wrapper2">
						...
						<div class="jp_top_jobs_category_wrapper">
							...
							<div class="jp_top_jobs_category"> <i class="fa fa-cutlery"></i>
	...
	<div class="jp_register_section_main_wrapper">
		...
		<div class="jp_regis_left_side_box_wrapper">
			...
			<div class="jp_regis_left_side_box">
				...
				<img src="images/index_iv/icon_form2.png" alt="icon" />
		...
		<div class="jp_regis_right_side_box_wrapper">
			...
			<div class="jp_regis_right_side_box">
				...
				<img src="images/index_iv/icon_form.png" alt="icon" />
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="jp_pricing_sec_main_heading">

						<div class="jp_pricing_sec_heading">

							<h4>Pricing Plan</h4>

							<p>Default is 3 pack but you can add more if you want.</p>
						...
						<div class="pricing_btn_wrapper">
							...
							<div class="pricing_btn1">
								...
								<ul>
									...
									<li><a href="#"><i class="fa fa-plus-circle"></i> Get Started</a>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					...
					<div class="pricing_box1_wrapper pricing_box1_wrapper21">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					...
					<div class="pricing_box1_wrapper pricing_box1_wrapper22">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hidden-sm hidden-xs">
					...
					<div class="jp_down_mob_img_wrapper">
						...
						<img src="images/index_iv/downl_img.png" alt="mobail_img" />
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="jp_recent_resume_heading_wrapper">

						<div class="jp_recent_resume_heading">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					...
					<div class="jp_recent_resume_box_wrapper">
						...
						<div class="jp_recent_resume_img_wrapper">
							...
							<img src="images/index_iv/rr1.jpg" alt="resume_img" />
						...
						<div class="jp_recent_resume_cont_wrapper">
							...
							<p><i class="fa fa-folder-open-o"></i>  <a href="#">UI Designer</a>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					...
					<div class="jp_recent_resume_box_wrapper jp_recent_resume_box_wrapper3">
					...
					<div class="jp_recent_resume_view_btn_wrapper">
						...
						<div class="jp_recent_resume_view_btn">
							...
							<ul>
								...
								<li><a href="#"><i class="fa fa-plus-circle"></i> &nbsp;VIEW ALL</a>
	...
	<div class="jp_testi_slider_main_wrapper">

		<div class="jp_testi_slider_img_overlay"></div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="jp_testi_slider_heading_wrapper">

						<div class="jp_testi_slider_heading">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="jp_testi_slider_wrapper">

						<div class="owl-carousel owl-theme">

							<div class="item">

								<div class="jp_testi_main_wrapper">

									<img src="images/content/client_slider_img.jpg" alt="testi_img" />

									<div class="jp_testi_cont_wrapper">
										...
										<h4><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i>&nbsp;&nbsp; ~ Jeniffer Doe &nbsp;&nbsp;<span>(Ui Designer)</span></h4>
									...
									<div class="jp_career_slider_bottom_cont">
										...
										<ul>
											...
											<li>
												...
												<img src="images/content/blog_small_img.jpg" alt="small_img" class="img-circle">&nbsp;&nbsp; <a href="#">Jhon Doe</a>

											</li>

										</ul>

										<p><a href="#"><i class="fa fa-comments"></i></a>
								...
								<ul>
									...
									<li>
										...
										<a href="#">
											...
											<img src="images/index_iv/f3.png" alt="img">&nbsp;&nbsp;recent jobrecent job</a>
							...
							<div class="jp_footer_first_cont_wrapper">
								...
								<div class="jp_footer_first_cont">
									...
									<ul>
										...
										<li><i class="fa fa-plus-circle"></i>  <a href="#">READ MORE</a>
							...
							<div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper2">
								...
								<div class="jp_footer_candidate">
									...
									<ul>
										...
										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Add a Resume</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> candidate Dashboard</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Past Applications</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Job Alerts</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Bookmarks</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> My Account</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Your Jobs</a>
							...
							<div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper3">
								...
								<div class="jp_footer_candidate">
									...
									<ul>
										...
										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Browse candidates</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Employer Dashboard</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Add Job</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Job Page</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Job Packages</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Work Process</a>
							...
							<div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper4">
								...
								<div class="jp_footer_candidate">
									...
									<ul>
										...
										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> About Us</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Terms & Conditions</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Privacy Policy</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Careers with Us</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Sitemap</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Contact Us</a>

										</li>

										<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> FAQs</a>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="jp_bottom_footer_left_cont">
									...
									<p>Copyright 2018 © Jobpro. All rights reserved. Powered by <a href="#">Webstrot</a>
  ...
  <!-- chat box Wrapper end -->
	...
	<script src="js/custom_iv.js"></script>
