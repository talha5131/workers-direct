...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/responsive_v.css" />
...
<body>
				...
				<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 hidden-xs">
					...
					<div class="jp_top_header_left_wrapper">
						...
						<div class="jp_top_header_left_cont">
							...
							<p class=""><i class="fa fa-envelope"></i> &nbsp;Email :&nbsp;<a  href="mailto:info@workers-direct.com">info@workers-direct.com</a>
						...
						<div class="gc_header_wrapper">
							...
							<div class="gc_logo">
								...
								<a href="index.php ">
									...
									<img src="images/index_v/logo.png" alt="Logo" title="Workers Direct" class="img-responsive">
										...
										<div class="col-xs-6 col-sm-6">
											...
											<div class="gc_logo">
												...
												<a href="index.php ">
													...
													<img src="images/index_v/logo.png" alt="Logo" title="Grace Church">
													...
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 31.177 31.177" style="enable-background:new 0 0 31.177 31.177;" xml:space="preserve" width="25px" height="25px">
														...
														<g>
															...
															<g>
																...
																<path class="menubar" d="M30.23,1.775H0.946c-0.489,0-0.887-0.398-0.887-0.888S0.457,0,0.946,0H30.23    c0.49,0,0.888,0.398,0.888,0.888S30.72,1.775,30.23,1.775z" fill="#8dc539" />

															</g>

															<g>

																<path class="menubar" d="M30.23,9.126H12.069c-0.49,0-0.888-0.398-0.888-0.888c0-0.49,0.398-0.888,0.888-0.888H30.23    c0.49,0,0.888,0.397,0.888,0.888C31.118,8.729,30.72,9.126,30.23,9.126z" fill="#8dc539" />

															</g>

															<g>

																<path class="menubar" d="M30.23,16.477H0.946c-0.489,0-0.887-0.398-0.887-0.888c0-0.49,0.398-0.888,0.887-0.888H30.23    c0.49,0,0.888,0.397,0.888,0.888C31.118,16.079,30.72,16.477,30.23,16.477z" fill="#8dc539" />

															</g>

															<g>

																<path class="menubar" d="M30.23,23.826H12.069c-0.49,0-0.888-0.396-0.888-0.887c0-0.49,0.398-0.888,0.888-0.888H30.23    c0.49,0,0.888,0.397,0.888,0.888C31.118,23.43,30.72,23.826,30.23,23.826z" fill="#8dc539" />

															</g>

															<g>

																<path class="menubar" d="M30.23,31.177H0.946c-0.489,0-0.887-0.396-0.887-0.887c0-0.49,0.398-0.888,0.887-0.888H30.23    c0.49,0,0.888,0.398,0.888,0.888C31.118,30.78,30.72,31.177,30.23,31.177z" fill="#8dc539" />
					...
					<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 hidden-sm hidden-xs">
						...
						<div class="jp_navi_right_btn_wrapper">
							...
							<ul>
								...
								<li><a href="register.php "><i class="fa fa-user"></i>&nbsp; SIGN UP</a>
	...
	<div class="jp_map_indx_wrapper">
		...
		<div class="jp_slider_form_main_wrapper">
			...
			<div class="jp_slider_form_location_wrapper"> <i class="fa fa-dot-circle-o first_icon"></i>
			...
			<div class="jp_slider_form_location_wrapper"> <i class="fa fa-th-large first_icon"></i>
			...
			<div class="jp_slider_form_location_wrapper"> <i class="fa fa-line-chart first_icon"></i>
			...
			<div class="jp_slider_form_location_wrapper"> <i class="fa fa-money first_icon"></i>
		...
		<div class="jp_tittle_slider_main_wrapper">
									...
									<div class="item" data-hash="zero">
										...
										<div class="row">
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												...
												<div class="jp_hiring_content_main_wrapper jp_hiring_content_main_wrapper_index_v">

													<div class="jp_hiring_content_wrapper jp_hiring_content_wrapper_indx_v">
	...
	<div class="jp_counter_main_wrapper">
		...
		<div class="container">
			...
			<div class="gc_counter_cont_wrapper">
				...
				<div class="count-description">	<i class="fa fa-star"></i>

					<h5 class="con1">Jobs Available</h5>

					<span class="timer">2540</span>
			...
			<div class="gc_counter_cont_wrapper2">
				...
				<div class="count-description">	<i class="fa fa-user-o"></i>
			...
			<div class="gc_counter_cont_wrapper3">
				...
				<div class="count-description">	<i class="fa fa-trophy"></i>
			...
			<div class="gc_counter_cont_wrapper4">
				...
				<div class="count-description">	<i class="fa fa-location-arrow"></i>
	...
	<div class="jb_testi_slider_main_wrapper">

		<div class="jb_testi_slider_img_overlay"></div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="jp_testi_heading_wrapper">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										...
										<div class="hs_testi_cont_main_wrapper">
											...
											<div class="hs_testi_cont_inner_wrapper">
												...
												<div class="hs_testi_quote_wrapper"> <i class="fa fa-quote-left"></i>
										...
										<div class="hs_testi_client_main_wrapper">
											...
											<div class="hs_testi_client_cont_img_sec">
												...
												<img src="images/index_v/testi_client_img1.jpg" alt="testi_img" />
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hidden-xs">
										...
										<div class="hs_testi_client_main_wrapper hs_testi_client_main_right_wrapper">
											...
											<div class="hs_testi_client_cont_img_sec">
												...
												<img src="images/index_v/testi_client_img2.jpg" alt="testi_img" />
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 hidden-sm hidden-xs">
					...
					<div class="jp_down_mob_img_wrapper">
						...
						<img src="images/index_v/doun_img2.png" alt="mobail_img" />
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 visible-sm visible-xs">
					...
					<div class="jp_down_mob_img_wrapper">
						...
						<img src="images/index_v/doun_img2.png" class="img-responsive" alt="mobail_img" />
							...
							<div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper2">
								...
								<div class="jp_footer_candidate">
									...
									<ul>
										...
										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Add a Resume</a>

										</li>

										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> candidate Dashboard</a>

										</li>

										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Past Applications</a>
							...
							<div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper3">
								...
								<div class="jp_footer_candidate">
									...
									<ul>
										...
										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Browse candidates</a>

										</li>

										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Employer Dashboard</a>
										...
										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Job Packages</a>

										</li>

										<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Work Process</a>
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="jp_bottom_footer_left_cont">
									...
									<p>© 2019-20 Workers Direct. All Rights Reserved.</p>
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="jp_bottom_footer_right_cont">
									...
									<ul>
										...
										<li class="hidden-xs"><a href="#"><i class="fa fa-google-plus"></i></a>

										</li>

										<li class="hidden-xs"><a href="#"><i class="fa fa-vimeo"></i></a>
		    ...
		    function setMarkers(map, markers) {
		        ...
		        for (var i = 0; i < markers.length; i++) {
		            ...
		            google.maps.event.addListener(marker, "click", function() {
		                ...
		                infowindow.setContent(this.php );
