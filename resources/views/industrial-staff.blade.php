...
@section('title','Industrial Staff | Recruitment Agency London')
@section('keywords','industrial, staff')
@section('description','')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12  margin-bottom-20 pl-0">
                ...
                <div class="about_text_wrapper">
                    ...
                    <div class="section_heading section_2_heading ">
                        ...
                        <h2>Industrial Staff<span></span></h2>
