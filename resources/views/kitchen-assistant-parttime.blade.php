                    ...
                    <div class="jp_tittle_breadcrumb_main_wrapper">
                        ...
                        <div class="jp_tittle_breadcrumb_wrapper">
                            ...
                            <ul>
                                ...
                                <li>Kitchen Assistant (Part Time)</li>
                    ...
                    <div class="section_heading section_2_heading row">
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-40">
                            <table class="table table-bordered " style="width:100%">
                                <tr>
                                    <th>Job Titles</th>
                                    <td> Kitchen Assistant (Part Time)</td>
                                </tr>
                                <tr>
                                    <th>Job Category</th>
                        ...
                        <div class="col-md-12">
                            <ul>
                                ...
                                <li><i class="fa fa-caret-right"></i> Keep Kitchen Tidy and Clean all the time.</li>
