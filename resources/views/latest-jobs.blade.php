                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-30 pl-0">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Site Labourer with CSCS card</td>
                                    <td> Temporary </td>
                                    <td> West London </td>
                                    <td> £8.50 per hour </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Burger Chef X 4 </td>
                                    <td> Permanent, Full Time </td>
                                    <td> Central London </td>
                                    <td> £8.50 to £11 per hour </td>
                                </tr>
                                <tr>
                                    <td>Sous Chef X 2 </td>
                                    <td> Temporary, Part Time </td>
                                    <td> Central London </td>
                                    <td> £9.50 to £12 per hour </td>
                                </tr>
                                <tr>
                                    <td>Cafe Chef X 2 </td>
                                    <td> Permanent, Full Time </td>
                                    <td> Central London </td>
                                    <td> £8.00 to £10 per hour </td>
                                </tr>
                                <tr>
                                    <td>Breakfast Chef </td>
                                    <td> Temporary, Part Time </td>
                                    <td> Central London </td>
                                    <td> £8.50 to £10 per hour </td>
                                </tr>
                                <tr>
                                    <td>Barista X 3 </td>
                                    <td> Permanent, Full Time </td>
                                    <td> Central London </td>
                                    <td> £7.50 to £8.50 per hour</td>
                                </tr>
                            </tbody>
                        </table>
