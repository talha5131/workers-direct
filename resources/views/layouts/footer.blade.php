                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <div class="jp_contact_inputs_wrapper jp_contact_inputs3_wrapper">
                                                <label class="formsLabel" for="userType">Employer / Job Seeker</label>
                                                <i class="fa fa-map-marker" style="position: absolute;z-index: 1;top: 86px;left: 40px;color: #7CC24D;"></i><input type="text" placeholder="Employer/Job Seeker" name="userType" id="userType">
                                            </div>
