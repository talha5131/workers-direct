    ...
    <div class="jp_newsletter_wrapper">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div style="text-align:center; " class="col-md-6 margin-top-100">


                    <p style="color: white;">Temping Agency is a privately owned recruitment agency based in Central London, W1 area and Established as part of the Workers Direct Group in 2010, TA has delivered excellent recruitment and employment services to clients in a variety of industries.
                    </p>

                    <p style="color: white;" class="margin-top-20">Our services include recruitment, selection, placement, contract and temporary workers and our consultants are highly trained and experienced to deal with each step of the process.</p>
                </div>
                <div class="col-md-6 margin-top-100">
                    ...
                    <div class="jp_footer_first_cont" style="margin-left: 50px;">
                        <h2 style="color: #7CC24D;" class="margin-bottom-20">Locations</h2>
                        <ul class="locations">
                            <li>London</li>
                            <li>Manchester</li>
                            <li>Birmingham</li>
        ...
        <div class="container">
            ...
            <button type="button" style="background: #7CC24D;" class="btn quoteModalBtn btn-lg" data-toggle="modal" data-target="#myModal">Get A Quote</button>

            <!-- Modal -->
            <div class="modal fade" id="myModal" role="dialog">
                <div style="width: 1200px !important;" class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <div class="about_text_wrapper">
                                <div class="section_heading section_2_heading margin-bottom-30 container">
                                    <h2> Get A Quote</h2>
                                    <hr style="border-bottom: 1px solid #7CC24D;;margin-top: 30px;">
                                </div>
                            </div>
                            <div class="modal-body">
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    ...
                                    <div class="jp_footer_first_cont jp_contact_right_box_wrapper">
                                        ...
                                        <p style="margin-top: -40px;line-height: 43px;"> If you need an urgent staff, fill the quotation form and send back to us an one of our experts can start on your recruitement drive immidiately. In many cases, we can find suitable employees within a matter of hours.
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form id="getAQuoteForm">
                                                <div class="jp_contact_form_box" style="border: none;">
                                                    <div class="row">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="jp_footer_three_sec_main_wrapper">
                        ...
                        <a href="{{url('/')}}"><img src="{{url('public/assets/images/header/animated-logo-wd.gif')}}" alt="Logo" title="Workers Direct" class="img-responsive" style="cursor: inherit; margin-bottom: 15px; margin-left: 10px;"></a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            ...
                            <div class="jp_footer_first_cont">
                                ...
                                <p>Worker Direct is one of the most reputable temp agencies in the UK bringing a wealth of experience and dedication to the recruitment craft. We have worked with thousands of top clients across the country providing recruitment solutions. <span id="dots-7" style="display: inline;"> </span><span id="more-7" style="display: none;"> We specialise in both temporary and temp to permanent recruitment strategies, so whatever your needs are we can help take your business to the next level. </span></p>
                                ...
                                <div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper3">
                                    ...
                                    <div class="jp_footer_candidate">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{url('staffing-services/temporary-staffing')}}"><i class="fa fa-caret-right" aria-hidden="true"></i> Hire The Best Talent</a></li>

                                            <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> How We Work </a></li>

                                            <li><a href="{{url('why-us')}}"><i class="fa fa-caret-right" aria-hidden="true"></i> Why Workers Direct </a></li>

                                            <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Quick Placement </a></li>

                                            <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Most Cost-Effective Way to Hire</a></li>

                                            <li><a href="{{url('our-gurantee')}}"><i class="fa fa-caret-right" aria-hidden="true"></i> Our Guarantee </a></li>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper4">
                                    ...
                                    <div class="jp_footer_candidate">
                                        ...
                                        <ul>
                                            <li><a href="{{url('latest-jobs')}}"><i class="fa fa-caret-right" aria-hidden="true"></i> Find The Perfect Job</a></li>

                                            <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Immediate Start</a></li>

                                            <li><a href="{{url('temporary-jobs')}}"><i class="fa fa-caret-right" aria-hidden="true"></i> Temporary Jobs</a></li>

                                            <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i> Temp to Perm Jobs</a></li>
                                            ...
                                            <li><a href="https://play.google.com/store/apps/details?id=com.mst_developers.workers_direct&hl=en"><i class="fa fa-caret-right" aria-hidden="true"></i> Download Mobile App</a></li>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper4">
                                    ...
                                    <div class="jp_footer_candidate">
                                        ...
                                        <ul>
                                            <li><a href="{{url('/')}}"><img src="{{url('public/assets/images/header/animated-logo-wd.gif')}}" alt="Logo" title="Workers Direct" class="img-responsive" style="cursor: inherit; margin-bottom: 15px; margin-left: 10px;"></a></li>
                                            <div class="jp_footer_first_cont">

                                                <h4 class="margin-bottom-20">Head Office</h4>
                                            </div>

                                            <div class="jp_footer_first_cont_new_1">
                                                <p style="color: white;" class="margin-bottom-20">344-348 High road, Ilford IG1 1QP</p>
                                            </div>
                                            <div class=" jp_footer_first_cont jp_footer_first_cont_new">

                                                <h4>Locations</h4>
                                            
                                            </div>

                                            <div class="jp_footer_first_cont_new_1" style="margin-bottom: 5px;">

                                                <ul style="margin-top: 25px;">
                                                    <li style="padding: 0px; color: #FFFFFF;">London</li>
                                                    <li style="padding: 0px; color: #FFFFFF;">Manchester</li>
                                                    <li style="padding: 0px; color: #FFFFFF;">Birmingham</li>
                                                    <li style="padding: 0 0 10px 0; color: #FFFFFF;">Glasgow</li>
                                                </ul>
                                            ...
                                            <div class="jp_footer_first_cont_new_1 ">
                                                ...
                                                <p style="color: white;" class="margin-bottom-20">info@workers-direct.com</p>

                                            </div>

                                            <div class="jp_footer_first_cont jp_footer_first_cont_new_1">
                                            ...
                                            <div class="jp_footer_first_cont_new_1">
                                                ...
                                                <p style="color: white;" class="margin-bottom-20">+44 (0) 2030 869080</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="jp_bottom_footer_left_cont">
                                            ...
                                            <p> <span style="color: #7CC24D;"> Our Partners: </span><a href="https://staff-direct.co.uk"> Staff Direct</a> - <a href="https://labourer.agency">Labourer Agency</a> - <a href="https://recruitment-agency.london">Recruitement Agency London (RAL)</a> - <a href="https://temporary-staff.agency">Temporary Staffing Agency (TSA)</a> -  <a href="https://temping-agency.com">Temping Agency</a></p>
