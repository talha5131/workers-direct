                    ...
                    <div class="section_heading section_2_heading margin-top-20">
                        ...
                        <div>
                            <ul>
                                ...
                                <li><i class="fa fa-caret-right"></i> To run errands, such as picking up dry cleaning</li>
                                <li><i class="fa fa-caret-right"></i> To attend to the needs of guests or passengers for the duration of their stay</li>
                                <li><i class="fa fa-caret-right"></i> To run errands for guests or passengers, in some cases</li>
                                <li><i class="fa fa-caret-right"></i> To parks and retrieves guest vehicles, in some cases</li>
                                <li><i class="fa fa-caret-right"></i> To carry departing guests’ or passengers’ luggage to cars or taxis</li>
                                <li><i class="fa fa-caret-right"></i> To maintain appearance, cleanliness, and safety standards in hotel</li>
                                <li><i class="fa fa-caret-right"></i> To ensures guests and passengers leave safely in the event of an evacuation</li>
