        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper">
                    ...
                    <div class="section_heading section_2_heading pl-0">

                        <h2>Our Approach</span></h2>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="row about_text_wrapper">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>While many large businesses and corporations are able to conduct their own recruitment in-house, small-to-medium range businesses usually don’t have the resources or expertise needed to conduct recruitment to a high level. In such cases, Workers Direct undoubtedly the optimal method of recruiting the best candidates.</p>
                    </div>

                    <ul>
                        <li> <i class="fa fa-caret-right"></i><strong style="color: #7CC24D;"> Expertise: </strong>It can take years, even decades, to develop the know-how and expertise of recruitment, and many companies simply aren’t able to achieve this on their own. As specialists in their field, Team Workers Direct have expertise in recruiting to the fore when working with clients. This expertise is indispensable to any recruitment drive and will help your company to pinpoint the best candidates in your field.</li>

                        <li> <i class="fa fa-caret-right"></i><strong style="color: #7CC24D;"> Streamlined Process: </strong> As many businesses will know, recruitment has a reputation for dragging on far too long if it isn’t done correctly. Filling a position can end up taking months and months, leaving your business without a solution and harming productivity. Our recruiters have mastered the art of recruiting from start to finish, so you can expect far quicker results.</li>

                        <li> <i class="fa fa-caret-right"></i><strong style="color: #7CC24D;"> Hassle-free: </strong> Recruitment can be a real pain for business owners, especially when there are dozens of other responsibilities to juggle at the same time. Having to conduct interviews, trawl through CV’s, and communicate with candidates can add an unwanted burden to your daily workload. Workers Direct as specialist recruitment agency will take on the full weight of the burden themselves and use their expertise to get it done professionally. </li>
                    </ul>
