...
@section('title','Painters & Decorators')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for a role of experienced Painters & Decorators in the area of Worthing.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        <h4>As a Painter and Decorator, your duties may include:</h4>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Applying paint or other materials such as stains, lacquer or varnish using brushes, rollers or spray equipment</li>
                            <li><i class="fa fa-caret-right"></i> Preparing and cleaning surfaces</li>
                            <li><i class="fa fa-caret-right"></i>Removing old wallpaper and paint</li>
                            <li><i class="fa fa-caret-right"></i> Repairing cracks and holes in walls</li>
                            <li><i class="fa fa-caret-right"></i> Mixing and thinning paint</li>
                            <li><i class="fa fa-caret-right"></i>Measuring, cutting and applying wallpaper or fabric to walls</li>
                            <li><i class="fa fa-caret-right"></i> Building and installing scaffolding</li>
                            <li><i class="fa fa-caret-right"></i> Advising customers on colour selection and choice of wall coverings</li>
                            <li><i class="fa fa-caret-right"></i> Reading specifications to determine required materials</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Proven experience as a painter</li>
                            <li><i class="fa fa-caret-right"></i>Excellent knowledge of painting material and how to select, mix and apply them</li>
                            <li><i class="fa fa-caret-right"></i>Solid knowledge of commercial and/or construction painting techniques</li>
                            <li><i class="fa fa-caret-right"></i>Aptitude in using appropriate tools (brushes, caulking guns etc.)</li>
                            <li><i class="fa fa-caret-right"></i>Good basic math skills</li>
                            <li><i class="fa fa-caret-right"></i>Manual dexterity with excellent balance to work on scaffolding, ladders etc.</li>
                            <li><i class="fa fa-caret-right"></i>Conscientious with great attention to detail</li>
                            <li><i class="fa fa-caret-right"></i>High school diploma; successful completion of an apprenticeship</li>
