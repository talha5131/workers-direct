...
@section('title','Part Time Cleaners')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for role of experienced Part Time Cleaners in the area of West London.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Clean, stock and supply designated facility areas (dusting, sweeping, vacuuming, mopping, cleaning ceiling vents, restroom cleaning etc)</li>
                            <li><i class="fa fa-caret-right"></i> Perform and document routine inspection and maintenance activities</li>
                            <li><i class="fa fa-caret-right"></i> Carry out heavy cleansing tasks and special projects</li>
                            <li><i class="fa fa-caret-right"></i> Notify management of occurring deficiencies or needs for repairs</li>
                            <li><i class="fa fa-caret-right"></i> Adjust and minor repairs</li>
                            <li><i class="fa fa-caret-right"></i> Stock and maintain supply rooms</li>
                            <li><i class="fa fa-caret-right"></i> Cooperate with the rest of the staff</li>
                            <li><i class="fa fa-caret-right"></i> Follow all health and safety regulations</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Proven working experience as a Cleaner</li>
                            <li><i class="fa fa-caret-right"></i> Ability to handle heavy equipment and machinery</li>
                            <li><i class="fa fa-caret-right"></i> Knowledge of cleaning chemicals and supplies</li>
                            <li><i class="fa fa-caret-right"></i> Familiarity with Material Safety Data Sheets</li>
                            <li><i class="fa fa-caret-right"></i> Integrity</li>
