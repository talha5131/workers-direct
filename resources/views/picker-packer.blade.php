...
@section('title','Picker & Packer Jobs - Recruitment Agency London | Workers Direct')
@section('keywords','Picker,Packer')
@section('description','Collect repaired equipment from all repair points. Clean all repaired equipment to high standards. Box equipment and seal, using the correct packaging. Label each box with the correct description and PET serial number, using a USB scanner.')
@section('content')
                ...
                <div class="about_text_wrapper">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-20">
                        ...
                        <ul>
                            ...
                            <li><i class="green fa fa-caret-right"></i>Collect repaired equipment from all repair points.</li>

                            <li><i class="green fa fa-caret-right"></i>Clean all repaired equipment to high standards.</li>

                            <li><i class="green fa fa-caret-right"></i>Box equipment and seal, using the correct packaging.</li>

                            <li><i class="green fa fa-caret-right"></i>Label each box with the correct description and PET serial number, using a USB scanner.</li>
                            <li><i class="green fa fa-caret-right"></i>Deliver packed goods to the warehouse for storage and distribution.</li>
                            <li><i class="green fa fa-caret-right"></i>Prepare goods for commissioning and installation as required.</li>
                            <li><i class="green fa fa-caret-right"></i>Adherance to company procedures, including ensuring that Health and Safety policies and procedures are followed at all times.</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-20">
                        ...
                        <ul>
                            ...
                            <li><i class="green fa fa-caret-right"></i>Previous experience of working in a similar role would be ideal, but is not essential.</li>

                            <li><i class="green fa fa-caret-right"></i>Demonstrable experience of working with cross-functional teams, and communicating.</li>

                            <li><i class="green fa fa-caret-right"></i>Personal Attributes and Behaviours</li>

                            <li><i class="green fa fa-caret-right"></i>Ability to adopt a professional and service-focussed style towards internal and external customers.</li>
                            <li><i class="green fa fa-caret-right"></i>Organisational awareness with the ability to communicate effectively with a range of internal teams.</li>
                            <li><i class="green fa fa-caret-right"></i>A good level of verbal and written communication skills, with the ability to form a rapport with others with ease.</li>
                            <li><i class="green fa fa-caret-right"></i>Ability to take a flexible and disciplined approach to workload.</li>
                            <li><i class="green fa fa-caret-right"></i>Good planning and organisational skills, with the ability to prioritise tasks effectively.</li>
