            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for a role of experienced Pickers & Painters in the area of Southall.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        <h4>Picker/Packer Job Responsibilities:</h4>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Pulls and packs product based on daily orders.</li>
                            <li><i class="fa fa-caret-right"></i> Meets specifics of customer orders in a timely manner.</li>
                            <li><i class="fa fa-caret-right"></i>Keeps products separated, organized and in good rotation.</li>
                            <li><i class="fa fa-caret-right"></i> Monitors product quality frequently, reporting problems to mitigate safety issues.</li>
                            <li><i class="fa fa-caret-right"></i> Operates various pieces of equipment (i.e. Bendi, Palletizer, Dolly Loader, Pallet Wrapper, Forklift, and Electrical Pallet Jacks).</li>
                            <li><i class="fa fa-caret-right"></i>Reports any mechanical problems.</li>
                            <li><i class="fa fa-caret-right"></i> Utilizes continuous improvement mindset and assists in identifying opportunities to improve processes.</li>
                            <li><i class="fa fa-caret-right"></i> Follows good manufacturing practices and required work safe practices.</li>
                            <li><i class="fa fa-caret-right"></i> Maintains a clean, sanitary, and safe work area.</li>
                            <li><i class="fa fa-caret-right"></i> Performs other duties as assigned.</li>

                        </ul>
                    </div>

                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        <h4>Picker/Packer Qualifications / Skills:</h4>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>	Scanning and sorting outgoing stock</li>
                            <li><i class="fa fa-caret-right"></i>	Pulling, packing, and loading</li>
                            <li><i class="fa fa-caret-right"></i>	Receiving, stocking, and stacking</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        <h4>Education, Experience, and Licensing Requirements:</h4>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>High school diploma, GED, or equivalent</li>
                            <li><i class="fa fa-caret-right"></i>6 months retail or customer service experience preferred</li>
                            <li><i class="fa fa-caret-right"></i>Forklift Certification within 90 days of job entry date</li>
                            <li><i class="fa fa-caret-right"></i>Familiarity with Radio Frequency (RF) equipment preferred</li>
