...
@section('title','Recruitment Agency In Snow Hill | Workers Direct')
@section('keywords','recruitment,snowhill')
@section('description','')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="jp_tittle_heading_wrapper">
                    ...
                    <div class="jp_tittle_heading">
                        ...
                        <h1>Recruitment Agency In Snow Hill</h1>
                    ...
                    <div class="jp_tittle_breadcrumb_main_wrapper">
                        ...
                        <div class="jp_tittle_breadcrumb_wrapper">
                            ...
                            <ul>
                                ...
                                <li>Recruitment Agency In Snow Hill</li>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-bottom-20">
                ...
                <div class="about_text_wrapper">
                    ...
                    <div class="section_heading section_2_heading">
                        ...
                        <h2>Recruitment Agency In Snow Hill</h2>
