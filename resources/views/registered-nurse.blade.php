...
@section('title','Registered Nurse')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for a role of an experienced Registered Nurse in Manchester.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Monitor patient’s condition and assess their needs to provide the best possible care and advice</li>
                            <li><i class="fa fa-caret-right"></i> Observe and interpret patient’s symptoms and communicate them to physicians</li>
                            <li><i class="fa fa-caret-right"></i> Collaborate with physicians and nurses to devise individualized care plans for patients</li>
                            <li><i class="fa fa-caret-right"></i> Perform routine procedures (blood pressure measurements, administering injections etc.) and fill in patients’ charts</li>
                            <li><i class="fa fa-caret-right"></i> Adjust and administer patient’s medication and provide treatments according to physician’s orders</li>
                            <li><i class="fa fa-caret-right"></i> Inspect the facilities and act to maintain excellent hygiene and safety (decontaminating equipment, sanitizing surfaces, preparing beds etc.)</li>
                            <li><i class="fa fa-caret-right"></i> Provide instant medical care in emergencies</li>
                            <li><i class="fa fa-caret-right"></i> Assist surgeons during operations</li>
                            <li><i class="fa fa-caret-right"></i> Supervise and train LPNs and nursing assistants</li>
                            <li><i class="fa fa-caret-right"></i> Foster a supportive and compassionate environment to care for patients and their families</li>
                            <li><i class="fa fa-caret-right"></i> Expand knowledge and capabilities by attending educational workshops, conferences etc.</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Proven experience as a registered nurse</li>
                            <li><i class="fa fa-caret-right"></i>Excellent knowledge of nursing care methods and procedures</li>
                            <li><i class="fa fa-caret-right"></i>Excellent knowledge of emergency care</li>
                            <li><i class="fa fa-caret-right"></i>In-depth knowledge of health and safety guidelines and procedures (sanitation, decontamination etc.) and willingness to follow them at all times</li>
                            <li><i class="fa fa-caret-right"></i>A team player with excellent communication and interpersonal skills</li>
                            <li><i class="fa fa-caret-right"></i>Responsible and compassionate</li>
                            <li><i class="fa fa-caret-right"></i>Outstanding organizational and multi-tasking skills</li>
                            <li><i class="fa fa-caret-right"></i>Patient with excellent problem-solving skills</li>
                            <li><i class="fa fa-caret-right"></i>BSc or other diploma from a nursing program</li>
                            <li><i class="fa fa-caret-right"></i>Valid nursing license</li>
