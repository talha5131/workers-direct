            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for experienced sales agents for few months who have outstanding communication and social skills. They will assist customer in attaining Covid 19 testing products. This job needs to maintain high level customer satisfaction.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Ensure high levels of customer satisfaction through excellent sales service</li>
                            <li><i class="fa fa-caret-right"></i>Maintain outstanding store condition and visual merchandising standards</li>
                            <li><i class="fa fa-caret-right"></i>Maintain a fully stocked store</li>
                            <li><i class="fa fa-caret-right"></i>Ascertain customers’ needs and wants</li>
                            <li><i class="fa fa-caret-right"></i>Recommend and display items that match customer needs</li>
                            <li><i class="fa fa-caret-right"></i>Welcome and greet customers</li>
                            <li><i class="fa fa-caret-right"></i>Manage point-of-sale processes</li>
                            <li><i class="fa fa-caret-right"></i>Actively involve in the receiving of new shipments</li>
                            <li><i class="fa fa-caret-right"></i>Keep up to date with product information</li>
                            <li><i class="fa fa-caret-right"></i>Accurately describe product features and benefits</li>
                            <li><i class="fa fa-caret-right"></i>Follow all companies policies and procedures</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Proven working experience in retail sales</li>
                            <li><i class="fa fa-caret-right"></i>Basic understanding of sales principles and customer service practices</li>
                            <li><i class="fa fa-caret-right"></i>Proficiency in English</li>
                            <li><i class="fa fa-caret-right"></i>Track record of over-achieving sales quota</li>
                            <li><i class="fa fa-caret-right"></i>Solid communication and interpersonal skills</li>
                            <li><i class="fa fa-caret-right"></i>Customer service focus</li>
                            <li><i class="fa fa-caret-right"></i>Friendly, helpful, confident and engaging personality</li>
                            <li><i class="fa fa-caret-right"></i>Basic administration skills</li>
