...
@section('title','School Caretaker')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for role of an experienced School Caretaker in the area of West London.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> cleaning or supervising cleaners;</li>
                            <li><i class="fa fa-caret-right"></i> controlling access to the premises, maintaining security and reporting incidents, such as vandalism, to the police and head teacher;</li>
                            <li><i class="fa fa-caret-right"></i> reporting items needing repair, carrying out basic repairs (such as replacing broken window panes or fixing leaking taps), arranging for outside contractors to do more complicated repairs;</li>
                            <li><i class="fa fa-caret-right"></i> looking after the school's swimming pool;</li>
                            <li><i class="fa fa-caret-right"></i> maintaining the school's grounds, or supervising staff carrying out this work;</li>
                            <li><i class="fa fa-caret-right"></i> dealing with lettings in the evenings and at weekends.</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <p>School Caretakers need to be:</p>
                    </div>
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">

                        <ul>
                            <li><i class="fa fa-caret-right"></i> capable of establishing good working relationships with the head teacher, office and teaching staff, pupils, parents, cleaners, etc;</li>
                            <li><i class="fa fa-caret-right"></i> flexible in their approach to planning the working day;</li>
                            <li><i class="fa fa-caret-right"></i> well organised, conscientious and reliable;</li>
                            <li><i class="fa fa-caret-right"></i> practical, with basic DIY skills;</li>
                            <li><i class="fa fa-caret-right"></i> able to undertake physical elements of the role.</li>
