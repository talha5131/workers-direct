            ...
            <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
                ...
                <div class="about_text_wrapper abt_2_para">
                    ...
                    <div class="section_heading section_2_heading margin-top-60">
                        <div>
                            <ul>
                                <li><i class="fa fa-caret-right"></i> Answering and forwarding incoming calls</li>
                                <li><i class="fa fa-caret-right"></i> Welcoming all visitors, ensuring they sign in and out of the building</li>
                                <li><i class="fa fa-caret-right"></i> General finance department filing</li>
                                <li><i class="fa fa-caret-right"></i> Ordering of office stationary and other consumables etc</li>
                            </ul>
                        </div>
                        ...
                        <div class="margin-top-60">
                            <ul>
                                <li><i class="fa fa-caret-right"></i> Previous experience in School as receptionist</li>
                                <li><i class="fa fa-caret-right"></i> Enhanced DBS Certificate</li>
                                <li><i class="fa fa-caret-right"></i> Two Employment References</li>
