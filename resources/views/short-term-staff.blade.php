...
@section('title','Short Term Staff - Workers Direct the Best Staffing Agency')
@section('keywords','short,term')
@section('description','')
@section('content')
