                ...
                <div class="row about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-60">
                        ...
                        <div class="margin-top-60">
                            <ul>
                                <li><i class="fa fa-caret-right"></i>Running the kitchen when the head chef is away.</li>
                                <li><i class="fa fa-caret-right"></i>Managing food purchasing and storage.</li>
                                <li><i class="fa fa-caret-right"></i>Maintaining a safe and hygienic kitchen environment.</li>
                                <li><i class="fa fa-caret-right"></i>Helping create new recipes and write menus Sous Chef.</li>
                                <li><i class="fa fa-caret-right"></i>Salary 25000 to 30000 per year Plus other benefits.</li>
                            </ul>
                        </div>
