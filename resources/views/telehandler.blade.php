            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                            We are looking for a role of an experienced Telehandler in the area of Windsor.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        <h4>Key Responsibilities/Essential Functions:</h4>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Follow all safety and environmental rules, regulations and procedures as set forth by company policies and OSHA/MSHA.</li>
                            <li><i class="fa fa-caret-right"></i> Follow all company policies and local, state and federal regulations for safe working procedures.</li>
                            <li><i class="fa fa-caret-right"></i> Ability and knowledge to operate and monitor equipment in a safe and efficient manner.</li>
                            <li><i class="fa fa-caret-right"></i> Ability to perform preventive maintenance and pre-shift inspections; repair and/or clean equipment as needed.</li>
                            <li><i class="fa fa-caret-right"></i> Responsible for overall housekeeping including plant, equipment, and site.</li>
                            <li><i class="fa fa-caret-right"></i> Ability to comprehend and complete all needed paperwork in a timely and accurate manner.</li>
                            <li><i class="fa fa-caret-right"></i> Regular, reliable attendance at the worksite or assigned work location.</li>
                            <li><i class="fa fa-caret-right"></i> Other duties and responsibilities related to the nature of the job may be assigned on a temporary or permanent basis as needed.</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Must pass a drug screen and criminal background check</li>
                            <li><i class="fa fa-caret-right"></i>Possess a safe work history.</li>
                            <li><i class="fa fa-caret-right"></i>Have a positive attitude and proactive approach to our safety program.</li>
                            <li><i class="fa fa-caret-right"></i>High school diploma or general education degree (ged) preferred.</li>
                            <li><i class="fa fa-caret-right"></i>Good safety, behavior and attendance record.</li>
                            <li><i class="fa fa-caret-right"></i>The selected candidate will be required to work collectively in a team environment with other co-workers and managers.</li>
                            <li><i class="fa fa-caret-right"></i>Willingness to do other work as needed, including heavy labor.</li>
                            <li><i class="fa fa-caret-right"></i>Willingness to work outside in all weather extremes.</li>
                            <li><i class="fa fa-caret-right"></i>Willingness and ability to work a flexible schedule, including swing shift, graveyard shift, over time and weekends as required.</li>
                            <li><i class="fa fa-caret-right"></i>Ability to work near, around or on light or heavy equipment.</li>
                            <li><i class="fa fa-caret-right"></i>Able to work various times during day, night or weekend hours, at various locations</li>
