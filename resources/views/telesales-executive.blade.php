                ...
                <div class="about_text_wrapper abt_2_para">
                    ...
                    <div class="section_heading section_2_heading col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-20">
                        ...
                        <ul>
                            ...
                            <li><i class="green fa fa-caret-right"></i>Research and identify decision makers within targeted companies (internet, social media, phone)</li>

                            <li><i class="green fa fa-caret-right"></i>High volume outbound calling to contact decision makers and to present eLibrary solutions.</li>

                            <li><i class="green fa fa-caret-right"></i>Generate leads and coordinate face to face or phone meetings for international field sales teams.</li>

                            <li><i class="green fa fa-caret-right"></i>Log all sales activities on CRM and ensure all data is up to date.</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 section_heading section_2_heading margin-top-20">
                        ...
                        <ul>
                            ...
                            <li><i class="green fa fa-caret-right"></i>Minimum ONE year sales & relevant consulting experience over the phone.</li>

                            <li><i class="green fa fa-caret-right"></i>Energetic, proactive with a positive outlook.</li>

                            <li><i class="green fa fa-caret-right"></i>Self-motivated and winning attitude.</li>

                            <li><i class="green fa fa-caret-right"></i>Great organisational skills.</li>
                            <li><i class="green fa fa-caret-right"></i>Excellent communication (German & English) & presentation skills.</li>
                            <li><i class="green fa fa-caret-right"></i>The ability to think on your feet/lots of initiative and a positive attitude.</li>
                            <li><i class="green fa fa-caret-right"></i>Team Player</li>
