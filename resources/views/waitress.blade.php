                ...
                <div class="about_text_wrapper">
                    ...
                    <div class="section_heading section_2_heading">
                        ...
                        <div class="margin-top-40 col-md-6">
                            ...
                            <img class="image-style-border" src="{{url('public/assets/images/page-pictures/WAITRESS/waitress_3.jpg')}}" width="100%" height="300px" alt="about-img">

                        </div>

                        <div class="margin-top-40 col-md-6">

                            <img class="image-style-border" src="{{url('public/assets/images/page-pictures/WAITRESS/waitress_2.jpg')}}" width="100%" height="300px" alt="about-img">
                        ...
                        <div class="margin-top-60 col-md-12">
                            <ul>
                                ...
                                <li><i class="fa fa-caret-right"></i> Clear the Tables</li>
