...
@section('title','Warehouse Assistant')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                        We are looking for a role of an experienced Warehouse Assistant in the area of Pewsey.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Prepare and complete orders for delivery or pickup according to schedule (load, pack, wrap, label, ship)</li>
                            <li><i class="fa fa-caret-right"></i> Receive and process warehouse stock products (pick, unload, label, store)</li>
                            <li><i class="fa fa-caret-right"></i> Perform inventory controls and keep quality standards high for audits</li>
                            <li><i class="fa fa-caret-right"></i> Keep a clean and safe working environment and optimise space utilisation</li>
                            <li><i class="fa fa-caret-right"></i> Complete diary logs into inventory</li>
                            <li><i class="fa fa-caret-right"></i> Report any discrepancies</li>
                            <li><i class="fa fa-caret-right"></i> Communicate and cooperate with supervisors and co-workers</li>
                            <li><i class="fa fa-caret-right"></i> Operate and maintain preventively warehouse vehicles and equipment</li>
                            <li><i class="fa fa-caret-right"></i> Follow quality service standards and comply with procedures, rules and regulations</li>
