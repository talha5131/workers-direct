...
@section('title','Warehouse Operatives')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                ...
                <div class="about_text_wrapper ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>
                        We are looking for a role of an experienced Warehouse Operatives in Southall.
                        </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0">
                        ...
                        <p>Here are the typical duties of a warehouse operative:</p>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 ">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i> Loading and unloading delivery vehicles, by hand or with a forklift truck.</li>
                            <li><i class="fa fa-caret-right"></i> Checking for damaged or missing items and then sorting stock for storage in the warehouse.</li>
                            <li><i class="fa fa-caret-right"></i> Taking goods to the appropriate storage space – perhaps using loading and lifting gear for heavy goods, like washing machines.</li>
                            <li><i class="fa fa-caret-right"></i> Keeping a careful record of the stock on the warehouse management system, so that it can be located quickly.</li>
                            <li><i class="fa fa-caret-right"></i> Operating a forklift truck to move and rearrange stock and ensure that products are stored safely (especially chemicals and food) and labelled correctly and safely (especially chemicals and food).</li>
                            <li><i class="fa fa-caret-right"></i> Picking orders using a hand-held scanner from the storage space and bringing them for packing, or to the loading bay for transportation.</li>
                            <li><i class="fa fa-caret-right"></i> As a packer, you may spend most of your time at a packing machine or conveyor line. You’ll put products into containers, such as boxes and crates, using bubble wrap or polystyrene chips, and then seal the containers ready for delivery to shops and stores. You will also ensure orders are packaged and labelled correctly to prevent returned orders.</li>
                            <li><i class="fa fa-caret-right"></i> Organising transfers and loading goods on to delivery vehicles. </li>
                            <li><i class="fa fa-caret-right"></i> Cleaning and maintaining the warehouse will also be part of the daily routine.</li>
                            <li><i class="fa fa-caret-right"></i> With heavy equipment in operation warehouses can be dangerous places, so following workplace health and safety rules will be essential.</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 pl-0 margin-top-40">
                        ...
                        <ul>
                            <li><i class="fa fa-caret-right"></i>Proven working experience as a Warehouse Worker</li>
                            <li><i class="fa fa-caret-right"></i>Proficiency in inventory software, databases and systems</li>
                            <li><i class="fa fa-caret-right"></i>Familiarity with modern warehousing practices and methods</li>
                            <li><i class="fa fa-caret-right"></i>Good organisational and time management skills</li>
                            <li><i class="fa fa-caret-right"></i>Ability to lift heavy objects</li>
                            <li><i class="fa fa-caret-right"></i>Current forklift licence</li>
                            <li><i class="fa fa-caret-right"></i>High school degree</li>
