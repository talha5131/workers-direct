            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-40">
                ...
                <div class="about_text_wrapper">
                    ...
                    <div class="section_heading section_2_heading">
                        ...
                        <h4>Finding the Right Temp on Right Time</h4>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 margin-top-40">
                ...
                <div class="about_text_wrapper">
                    ...
                    <div class="section_heading section_2_heading">
                        ...
                        <h4>Temps Registered With us</h4>

                        <p>As a temping agency we vetted all candidates with great vigour. Being a top temp agency our consultants not only present the candidate’s CV, but also with test results of their skills and full reference checks. The consultant that you deal with will have had a thorough face-to-face interview with the candidate and will be able to tell you his / her impressions of the candidate.</p>
